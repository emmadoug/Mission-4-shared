...
clipboardButton.addEventListener('click', (e) => {
  ...
  // clipboardButton.textContent = 'reference number copied'
  if (currentIcon === 'icon1') {
    iconContainer.innerHTML = icon2
    currentIcon = 'icon2'
    // alert('copied to clipboard')
    console.log(referenceNumber.textContent)
    copyClipboard(referenceNumber.textContent)
  }
})
